  ...
  config = function()
    ...
    cmp.setup {
      ...
      mapping = cmp.mapping.preset.insert {
        ...
        [keymaps.autocompletion.scroll_docs_forward] = cmp.mapping.scroll_docs(4),

        -- Accept ([y]es) the completion.
        --  This will auto-import if your LSP supports it.
        --  This will expand snippets if the LSP sent a snippet.
        [keymaps.autocompletion.confirm] = cmp.mapping.confirm { select = true },
        ...
        [keymaps.autocompletion.complete] = cmp.mapping.complete {},
